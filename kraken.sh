...
hisat2-build -p 8 ${outputDir}/consensusHIV/${sample}.fa ${outputDir}/consensusHIV/${sample}
echo ALIGNING WITH hisat2
hisat2 -p 8 --no-unal -x ${outputDir}/consensusHIV/${sample} -1 ${inputDir}/${sampleR1Base} -2 ${inputDir}/${sampleR2Base} -S ${outputDir}/hisat/${sample}.sam