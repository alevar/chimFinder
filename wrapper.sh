...
for file in ${inputDir}/*R1*fastq.gz ; do
	...
	if [[ $sample == *"pos"* || $sample == *"Pos"* ]]; then
		...
		# ${trim_galore} --trim-n -q 5 --phred33 --length 65 -o ./${outputDir}_R1/tmp/trim/ --dont_gzip ${inputDir}/${sampleR1Base}
		...
		# ${trim_galore} --trim-n -q 5 --phred33 --length 65 -o ./${outputDir}_R2/tmp/trim/ --dont_gzip ${inputDir}/${sampleR2Base}
